...
// import { reqSubmitOrder } from "../../api/index"; //可以这样引入，但是每个文件用到的每一个函数都需要这样引入，太麻烦了
//所以在main.js文件中，统一接收api文件夹中的全部请求函数
export default {
  name: "Trade",
  //生命周期函数：挂载完毕
  mounted() {
    this.$store.dispatch("getUserAddress");
    this.$store.dispatch("getOrderIndo");
  },
  computed: {
    ...mapState({
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        paymentWay: "ONLINE", //最终收件人的付款方式
        orderComment: this.msg, //最终收件人的留言
